export default function Footer(){
    return (
        ...
        <div className="footer p-5 border-t-2 leading-10  border-gray-300">
            ...
            <div className="">
                <h4>Newsletter</h4>
            <input type="text" placeholder="Your Email" className=" m-5  border-2 p-2 rounded-lg" />
            <button type="submit" className="font-bold border-2 p-2 rounded-lg">SUBSCRIBE</button>
            </div>
